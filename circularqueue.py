...
# today we will study circular queue
#
# since circular queue is a queue with extra feature of ability of
# containing exactly number of elements as of its length even after
# an element is deleted from the queue.
